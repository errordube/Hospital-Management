...
#empty list to later append the ids from the data
ids = []
...
class Application:
    def __init__(self,master):
        ...
        self.heading = Label(self.left,text="Dube Hospital Appointments",font=('aerial 40 bold'),fg='black',bg='lightgreen')
        self.heading.place(x=0,y=0)
        
        #patient name
        self.name = Label(self.left,text="Patient Name",font=('aerial 18 bold'),fg='black',bg='lightgreen')
        ...
        #appointment time
        self.time = Label(self.left,text="Appointment Time",font=('aerial 18 bold'),fg='black',bg='lightgreen')
        self.time.place(x=0,y=260)

        #phone
        self.phone = Label(self.left,text="Phone Number",font=('aerial 18 bold'),fg='black',bg='lightgreen')
        ...
        self.logs = Label(self.right, text ="Logs", font=('aerial 28 bold'),fg='white',bg='steelblue')
    ...
    def add_appointment(self):
        ...
        if self.val1 == '' or self.val2 == '' or self.val3 == '' or self.val4 == '' or self.val5 == '' or self.val6 == '':
            tkinter.messagebox.showinfo("Warning","Please fill up the boxes")
        else:
            #add to the database
