...
class Application:
    def __init__(self,master):
        ...
        self.name=Label(master,text="Enter Patient Name",font=('arial 18 bold'))
    ...
    def search_db(self):
        ...
        self.uname = Label(self.master,text="Patient Name",font=('arial 18 bold'))
    ...
    def update_db(self):
        ...
        self.run = c.execute(query,(self.var1, self.var2, self.var3, self.var4, self.var5, self.var6, self.namenet.get(),))
        conn.commit()
    ...
    def delete_db(self):
        ...
        conn.commit()
        tkinter.messagebox.showinfo("Deleted","Succesfully Deleted")
        self.ent1.destroy()
        self.ent2.destroy()
        self.ent3.destroy()
        self.ent4.destroy()
